...
class DrawList {
public:
    enum class CommandType { TEXT, FILL_RECT, OUTLINE_RECT, ROUNDED_RECT, FILL_ROUNDED_RECT, QUAD, FILL_QUAD, LINE, IMAGE, FILL_CIRCLE, CIRCLE, PIE, OUTLINE_PIE, RING, OUTLINE_RING, PUSH_TRANSFORM, POP_TRANSFORM };
    ...
    struct [[nodiscard]] CommandLock {
        ...
        void push_transform(float x, float y, float scale);
        void pop_transform();
    };
